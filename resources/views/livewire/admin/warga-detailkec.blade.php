...
<table width="100%" class="table" border="0" cellspacing="0" cellpadding="2">
    <tr>
...
@endif
    ...
    <x-slot name="footer">
        <button type="button" class="btn btn-primary" wire:click="cetakkec({{ $id }})">
            <i class="fas fa-times-print"></i> Cetak
        </button>
