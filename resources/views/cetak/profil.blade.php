...
<body class="Foolscap"> 
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="2">
            ...
            <tr>
                <td></td>
                <td> Koordinat </td>
                <td colspan="3">: {{ $warga->koordinat }}</td>
            </tr>
            <tr>
                <td></td>
                <td> Jumlah KK </td>
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="2">
            ...
            <tr>
                <td ></td>
                <td  colspan="4">Penanggung Jawab Kegiatan Keagamaan</td>
                <td colspan="3" align="center" >
                    @if($warga->kkm) @forelse($warga->kkm
                    ->where('jenis', '=', 'Kegiatan Keagamaan') as $a)
                    {{$a->pj  }}
            ...
            <tr>
                <td ></td>
                <td  colspan="4">Jumlah Anggota Kegiatan Keagamaan </td>
                <td colspan="3" align="center" >
                    @if($warga->kkm) @forelse($warga->kkm
                    ->where('jenis', '=', 'Kegiatan Keagamaan') as $a)
                    {{$a->jml_anggota  }}
            ...
            <tr>
                <td rowspan="2"></td>
                <td rowspan="2" valign="middle" colspan="3">Akses Sanitasi </td>
